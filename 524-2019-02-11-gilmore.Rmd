...
- Teller, D. Y. (1997). First glances: The vision of infants. The Friedenwald lecture. *Investigative Ophthalmology & Visual Science*, *38*(11), 2183–2203. Retrieved from https://www.ncbi.nlm.nih.gov/pubmed/9344342
...
- Exteroception
    - What's in the world?
    - Where is it located? Where is it moving?
- Interoception
    - Where am I? Where am I moving?
    - How am I doing?
    
---

| Information type | Channel type | Sense | Action type |
|------------------|--------------|-------|-------------|
| Geometry/layout  | Electromagnetic energy (light) | Vision | Locomotion, orientation, manipulation |
|                  | Electromagnetic energy (magnetism) | Magnetoreception | Locomotion, orientation |
|                  | Electromagnetic energy (electricity) | Electroreception | Locomotion, orientation |
|                  | Mechanical (vibration) | Audition | Locomotion, orientation |
|                  | Chemical concentration | Olfaction | Locomotion, orientation |
|                  | Thermal energy         | Thermoception | Locomotion, orientation |

---

| Information type | Channel type | Sense | Action type |
|------------------|--------------|-------|-------------|
| Object/surface properties  | Electromagnetic energy (light) | Vision | Shape, color, texture, animacy, identity |
|                  | Electromagnetic energy (electricity) | Electroreception | Identity |
|                  | Mechanical (vibration) | Audition | Identity |
|                  |                        | Touch     | Substance type, texture, deformability, inertia, temperature ... |
...
| Information type | Channel type | Sense | Action type |
|------------------|--------------|-------|-------------|
| Object/surface properties                 | Chemical concentration | Olfaction | Identity |
|                  |                        | Gustation | Identity |
|                  |                        | Digestion | ???      |
...
| Information type | Channel type | Sense | Action type |
|------------------|--------------|-------|-------------|
| Proprioception | Electromagnetic energy (light) | Vision | Position, orientation |
|                  | Electromagnetic energy (electricity) | Electroreception | Identity |                  | Mechanical (linear, rotational acceleration) | Vestibular | Locomotion, orientation |
|                  | Mechanical (joint tension/force) | Kinesthesia | Joint length, force, position |
...
## Geometric structure of optic array
...
A. Newborn, B. 1-mo, C. 2-mos, D. 3-mos
...
<img src="img/moco-psychophysics-display.jpg" height=550px/>
...
- Behavioral/postural changes (crawling vs. walking, head/eye stability, ...)
...
- "Why does visual acuity increase so much faster in infant monkeys than in human infants? Is this because macaques reach full maturity at a much faster rate than humans in general?"
- "These two examples suggest to me that brain activity might predict later behavioral development. Are there developmental theories that consider this brain before behavior aspect in its model?"
- "...Is this [Teller's] method of color discrimination truly the best method to assess the development of infant color vision?"

---

- "However, a large body of work suggests that the interactive specialization theory is a better framework for examining the development of sensory, motor, and cognitive functions...Does the field need to use neuroscientific methods to resolve this conflict in theoretical perspectives? If so, what is the place of behavioral work in these theoretical debates?"
...
- Can psychophysically-inspired methods (measuring response functions) apply to your problems?
...
- "Behaviors"
    - Changes in body position or orientation
    - Vocalization
- "Physiological responses"
    - Changes in heart rate, respiration, pupil dilation, skin conductance
    - Hormonal secretions (cortisol, oxytocin, vasopressin, melatonin, insulin, ...)
...
- "...Can neuroscience methodology really test causality between brain activation and function/behavior if we cannot know what the very basis (i.e. inhibition or excitation) of activation is?"
- "Can we ever go beyond finding correlations between neural activities and behavior using neuroscience practices?"
...
- Does neuroscience have a 'reductionist bias' that needs to be corrected?
- Does psychology?
...
- "I wonder how often the data that is shared will be accessed and utilized. There are very few systems in place that reward researchers for spending time examining data collected by their colleagues. How can the field promote use of the data shared and reward replication?
- "How might data sharing techniques assist in addressing Marr’s three levels of analyses within the context of cognitive neuroscience?"

---

- "I thought about how there may be other reasons besides the challenges involved with personally identifiable data for why researchers do not share, such as worry that the method will only be loosely replicated or that the original study won’t hold up. I was curious, then, about the importance of being able to replicate behavioral data prior to doing any neuroscience study that builds on it."
- "How can we, as a community, systematically change the culture of academia such that we are more open to mistakes, criticisms, and making corrections without negative professional consequences?"

---

- "If stimuli are able to be shared more readily through these platforms, and multiple labs start to converge on utilizing the same stimuli in their paradigms, is there a reason to be concerned that effects we see may be purely or partially based on the stimuli that have been shared? Is there a downside to people utilizing the same stimuli?"
...
- Psychology is (or should be) a science of behavior and internal state
- Psychology is harder than physics...
    - But will progress slowly unless...
    - We commit to practices that make our theories clear and our findings cumulative
...
- What are the statistics of natural sensory (visual) experiences?
